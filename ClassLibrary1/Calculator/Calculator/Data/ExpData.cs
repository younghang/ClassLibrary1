...
namespace YHExcelAddin.Calculator.Calculator.Data
{
	/// <summary>
	...
	public class ExpData:CalData
	{
		...
		{
			string str = UIController.UIController.SimpleCal(express);
			if (str == null) {
				str = "0";
		...
		{
			string str = UIController.UIController.SimpleCal(value);
			if (str == null) {
				str = "0";
