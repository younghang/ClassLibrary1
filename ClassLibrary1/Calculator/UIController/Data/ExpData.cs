 ...
 */
using System;
using YHExcelAddin.Calculator.Calculator;

namespace YHExcelAddin.Calculator.UIController.Data
{
	/// <summary>
	...
	public class ExpData:CalData
	{
		...
		public string GetValue()
		{
			...
			result = sc.GetResult();
			if (sc.IsError()) {
				UIController.PushToShow("Wrong Input: " + express + "  Not Support Parameter Express!Value");
				UIController.PushToShow(sc.GetErrorMessage());
